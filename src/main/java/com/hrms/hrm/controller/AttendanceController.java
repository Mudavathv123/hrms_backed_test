...
public class AttendanceController {
        ...
        public ResponseEntity<ApiResponse<AttendanceResponseDto>> checkIn(@PathVariable UUID employeeId,
                ...
                return ResponseEntity.ok(ApiResponse.success(
                                attendanceService.checkIn(employeeId, latitude, longitude, locationName),
                                "check in successful"));
        }
        ...
        public ResponseEntity<ApiResponse<AttendanceResponseDto>> checkOut(@PathVariable UUID employeeId) {
                return ResponseEntity.ok(
                                ApiResponse.success(attendanceService.checkOut(employeeId), "check out successful"));
        }
        ...
        public ResponseEntity<ApiResponse<List<AttendanceResponseDto>>> getTodayAttendance() {
                return ResponseEntity
                                .ok(ApiResponse.success(attendanceService.getTodayAttendance(),
                                                "fetched today attendance success"));
        }
        ...
        public ResponseEntity<ApiResponse<?>> getMonthlyAttendance(@PathVariable UUID employeeId,
                ...
                return ResponseEntity
                                .ok(ApiResponse.success(attendanceService.getMonthlyAttendance(employeeId, year, month),
        ...
        public ResponseEntity<ApiResponse<List<WeeklyTimelineDto>>> getWeeklyTimeline(
                ...
                return ResponseEntity.ok(
                                ApiResponse.success(
                                                attendanceService.getWeeklyTimeline(authentication, employeeId,
                                                                weekStart),
        ...
        public ResponseEntity<ApiResponse<MonthlySummaryDto>> getAllMonthlyAttendance(
                        @RequestParam int year,
                        @RequestParam int month) {

                return ResponseEntity.ok(
                                ApiResponse.success(
                                                attendanceService.getAllMonthlyAttendance(year, month),
                                                "All employees monthly attendance fetched"));
        }
