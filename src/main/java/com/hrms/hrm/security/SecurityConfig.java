    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .hasAnyRole("ADMIN", "EMPLOYEE", "HR", "MANAGER")
...
// Employees can submit only their EOD?
                                .requestMatchers(HttpMethod.POST, "/api/eod").hasRole("EMPLOYEE")
                                // HR creates/approves/deletes EOD
                                .requestMatchers(HttpMethod.POST, "/api/eod/**").hasAnyRole("HR", "ADMIN")
                                .requestMatchers(HttpMethod.PUT, "/api/eod/**").hasAnyRole("ADMIN")
                                .requestMatchers(HttpMethod.DELETE, "/api/eod/**").hasAnyRole("ADMIN")

// Employees can submit only their EOD?
                                .requestMatchers(HttpMethod.POST, "/api/eod").hasRole("EMPLOYEE")

// Everyone authenticated can view
                                .requestMatchers(HttpMethod.GET, "/api/eod/**").authenticated()
